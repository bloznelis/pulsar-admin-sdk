...
/// struct for typed errors of method [`non_persistent_topics_create_partitioned_topic`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsCreatePartitionedTopicError {
    Status401(),
    Status403(),
    Status404(),
    Status406(),
...
/// struct for typed errors of method [`non_persistent_topics_get_entry_filters`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsGetEntryFiltersError {
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`non_persistent_topics_get_internal_stats`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsGetInternalStatsError {
    Status401(),
    Status403(),
    Status404(),
    Status412(),
...
/// struct for typed errors of method [`non_persistent_topics_get_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsGetListError {
    Status401(),
    Status403(),
    Status404(),
    Status412(),
...
/// struct for typed errors of method [`non_persistent_topics_get_list_from_bundle`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsGetListFromBundleError {
    Status401(),
    Status403(),
    Status404(),
    Status412(),
...
/// struct for typed errors of method [`non_persistent_topics_get_partitioned_metadata`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsGetPartitionedMetadataError {
    Status401(),
    Status403(),
    Status404(),
    Status412(),
...
/// struct for typed errors of method [`non_persistent_topics_get_partitioned_stats`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsGetPartitionedStatsError {
    Status401(),
    Status403(),
    Status404(),
    Status412(),
...
/// struct for typed errors of method [`non_persistent_topics_remove_entry_filters`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsRemoveEntryFiltersError {
    Status403(),
    Status404(),
    Status405(),
    Status409(),
...
/// struct for typed errors of method [`non_persistent_topics_set_entry_filters`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsSetEntryFiltersError {
    Status403(),
    Status404(),
    Status405(),
    Status409(),
...
/// struct for typed errors of method [`non_persistent_topics_truncate_topic`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsTruncateTopicError {
    Status412(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`non_persistent_topics_unload_topic`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NonPersistentTopicsUnloadTopicError {
    Status401(),
    Status403(),
    Status404(),
    Status412(),
...
pub async fn non_persistent_topics_create_partitioned_topic(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, body: i32, create_local_topic_only: Option<bool>) -> Result<(), Error<NonPersistentTopicsCreatePartitionedTopicError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/partitions", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsCreatePartitionedTopicError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn non_persistent_topics_get_entry_filters(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<NonPersistentTopicsGetEntryFiltersError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/entryFilters", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsGetEntryFiltersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn non_persistent_topics_get_internal_stats(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>, metadata: Option<bool>) -> Result<(), Error<NonPersistentTopicsGetInternalStatsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/internalStats", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsGetInternalStatsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn non_persistent_topics_get_list(configuration: &configuration::Configuration, tenant: &str, namespace: &str, bundle: Option<&str>, include_system_topic: Option<bool>) -> Result<Vec<String>, Error<NonPersistentTopicsGetListError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsGetListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn non_persistent_topics_get_list_from_bundle(configuration: &configuration::Configuration, tenant: &str, namespace: &str, bundle: &str) -> Result<Vec<String>, Error<NonPersistentTopicsGetListFromBundleError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{bundle}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), bundle=crate::apis::urlencode(bundle));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsGetListFromBundleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn non_persistent_topics_get_partitioned_metadata(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>, check_allow_auto_creation: Option<bool>) -> Result<(), Error<NonPersistentTopicsGetPartitionedMetadataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsGetPartitionedMetadataError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn non_persistent_topics_get_partitioned_stats(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, per_partition: Option<bool>, authoritative: Option<bool>, get_precise_backlog: Option<bool>, subscription_backlog_size: Option<bool>, get_earliest_time_in_backlog: Option<bool>, exclude_publishers: Option<bool>, exclude_consumers: Option<bool>) -> Result<models::NonPersistentPartitionedTopicStatsImpl, Error<NonPersistentTopicsGetPartitionedStatsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/partitioned-stats", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsGetPartitionedStatsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn non_persistent_topics_remove_entry_filters(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<NonPersistentTopicsRemoveEntryFiltersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsRemoveEntryFiltersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn non_persistent_topics_set_entry_filters(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>, body: Option<models::EntryFilters>) -> Result<(), Error<NonPersistentTopicsSetEntryFiltersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsSetEntryFiltersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn non_persistent_topics_truncate_topic(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<(), Error<NonPersistentTopicsTruncateTopicError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/truncate", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsTruncateTopicError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn non_persistent_topics_unload_topic(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<(), Error<NonPersistentTopicsUnloadTopicError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/unload", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NonPersistentTopicsUnloadTopicError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn persistent_topics_analyze_subscription_backlog(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, authoritative: Option<bool>, position: Option<models::ResetCursorData>) -> Result<(), Error<PersistentTopicsAnalyzeSubscriptionBacklogError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}/analyzeBacklog", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_compact(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsCompactError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/compaction", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
...
pub async fn persistent_topics_create_missed_partitions(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str) -> Result<(), Error<PersistentTopicsCreateMissedPartitionsError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/createMissedPartitions", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_create_non_partitioned_topic(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>, body: Option<std::collections::HashMap<String, String>>) -> Result<(), Error<PersistentTopicsCreateNonPartitionedTopicError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
...
pub async fn persistent_topics_create_subscription(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, subscription_name: &str, authoritative: Option<bool>, replicated: Option<bool>, message_id: Option<models::ResetCursorData>) -> Result<(), Error<PersistentTopicsCreateSubscriptionError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subscriptionName}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subscriptionName=crate::apis::urlencode(subscription_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
...
pub async fn persistent_topics_delete_deduplication_snapshot_interval(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsDeleteDeduplicationSnapshotIntervalError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/deduplicationSnapshotInterval", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn persistent_topics_delete_delayed_delivery_policies(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsDeleteDelayedDeliveryPoliciesError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/delayedDelivery", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn persistent_topics_delete_inactive_topic_policies(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsDeleteInactiveTopicPoliciesError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/inactiveTopicPolicies", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn persistent_topics_delete_max_unacked_messages_on_consumer(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsDeleteMaxUnackedMessagesOnConsumerError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/maxUnackedMessagesOnConsumer", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn persistent_topics_delete_max_unacked_messages_on_subscription(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsDeleteMaxUnackedMessagesOnSubscriptionError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/maxUnackedMessagesOnSubscription", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn persistent_topics_delete_shadow_topics(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsDeleteShadowTopicsError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/shadowTopics", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn persistent_topics_delete_subscription(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, force: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsDeleteSubscriptionError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn persistent_topics_examine_message(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, initial_position: Option<&str>, message_position: Option<i64>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsExamineMessageError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/examinemessage", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_expire_topic_messages(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, authoritative: Option<bool>, message_id: Option<models::ResetCursorData>) -> Result<(), Error<PersistentTopicsExpireTopicMessagesError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}/expireMessages", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_expire_topic_messages_0(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, expire_time_in_seconds: i32, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsExpireTopicMessages0Error>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}/expireMessages/{expireTimeInSeconds}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name), expireTimeInSeconds=expire_time_in_seconds);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_auto_subscription_creation(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsGetAutoSubscriptionCreationError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/autoSubscriptionCreation", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_backlog(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<models::PersistentOfflineTopicStats, Error<PersistentTopicsGetBacklogError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/backlog", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_backlog_quota_map(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, authoritative: Option<bool>, is_global: Option<bool>) -> Result<std::collections::HashMap<String, models::BacklogQuota>, Error<PersistentTopicsGetBacklogQuotaMapError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/backlogQuotaMap", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_backlog_size_by_message_id(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<i64, Error<PersistentTopicsGetBacklogSizeByMessageIdError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/backlogSize", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_compaction_threshold(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<i64, Error<PersistentTopicsGetCompactionThresholdError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/compactionThreshold", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_deduplication(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<bool, Error<PersistentTopicsGetDeduplicationError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/deduplicationEnabled", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_dispatch_rate(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsGetDispatchRateError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/dispatchRate", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_dispatcher_pause_on_ack_state_persistent(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<i32, Error<PersistentTopicsGetDispatcherPauseOnAckStatePersistentError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/dispatcherPauseOnAckStatePersistent", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_last_message_id(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsGetLastMessageIdError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/lastMessageId", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_managed_ledger_info(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<models::PartitionedManagedLedgerInfo, Error<PersistentTopicsGetManagedLedgerInfoError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/internal-info", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_max_consumers(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, applied: Option<bool>, authoritative: Option<bool>) -> Result<i32, Error<PersistentTopicsGetMaxConsumersError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/maxConsumers", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_max_consumers_per_subscription(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<i32, Error<PersistentTopicsGetMaxConsumersPerSubscriptionError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/maxConsumersPerSubscription", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_max_message_size(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<i32, Error<PersistentTopicsGetMaxMessageSizeError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/maxMessageSize", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_max_producers(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<i32, Error<PersistentTopicsGetMaxProducersError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/maxProducers", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_max_subscriptions_per_topic(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<i32, Error<PersistentTopicsGetMaxSubscriptionsPerTopicError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/maxSubscriptionsPerTopic", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_message_by_id(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, ledger_id: i64, entry_id: i64, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsGetMessageByIdError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/ledger/{ledgerId}/entry/{entryId}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), ledgerId=ledger_id, entryId=entry_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_message_id_by_timestamp(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, timestamp: i64, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsGetMessageIdByTimestampError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/messageid/{timestamp}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), timestamp=timestamp);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_message_ttl(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<i32, Error<PersistentTopicsGetMessageTtlError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/messageTTL", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_offload_policies(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsGetOffloadPoliciesError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/offloadPolicies", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_partitioned_stats_internal(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<models::PartitionedTopicInternalStats, Error<PersistentTopicsGetPartitionedStatsInternalError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/partitioned-internalStats", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_partitioned_topic_list(configuration: &configuration::Configuration, tenant: &str, namespace: &str, include_system_topic: Option<bool>) -> Result<Vec<String>, Error<PersistentTopicsGetPartitionedTopicListError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/partitioned", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_permissions_on_topic(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str) -> Result<(), Error<PersistentTopicsGetPermissionsOnTopicError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/permissions", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_persistence(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<models::PersistencePolicies, Error<PersistentTopicsGetPersistenceError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/persistence", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_properties(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<std::collections::HashMap<String, String>, Error<PersistentTopicsGetPropertiesError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/properties", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_publish_rate(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<models::PublishRate, Error<PersistentTopicsGetPublishRateError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/publishRate", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_replicated_subscription_status(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, authoritative: Option<bool>) -> Result<std::collections::HashMap<String, bool>, Error<PersistentTopicsGetReplicatedSubscriptionStatusError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}/replicatedSubscriptionStatus", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_replication_clusters(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, authoritative: Option<bool>) -> Result<Vec<String>, Error<PersistentTopicsGetReplicationClustersError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/replication", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_replicator_dispatch_rate(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, applied: Option<bool>, authoritative: Option<bool>) -> Result<models::DispatchRate, Error<PersistentTopicsGetReplicatorDispatchRateError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/replicatorDispatchRate", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_retention(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, applied: Option<bool>, authoritative: Option<bool>) -> Result<models::RetentionPolicies, Error<PersistentTopicsGetRetentionError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/retention", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_schema_compatibility_strategy(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, authoritative: Option<bool>) -> Result<String, Error<PersistentTopicsGetSchemaCompatibilityStrategyError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/schemaCompatibilityStrategy", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_schema_validation_enforced(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsGetSchemaValidationEnforcedError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/schemaValidationEnforced", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_stats(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>, get_precise_backlog: Option<bool>, subscription_backlog_size: Option<bool>, get_earliest_time_in_backlog: Option<bool>, exclude_publishers: Option<bool>, exclude_consumers: Option<bool>) -> Result<models::PersistentTopicStats, Error<PersistentTopicsGetStatsError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/stats", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_subscribe_rate(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<models::SubscribeRate, Error<PersistentTopicsGetSubscribeRateError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscribeRate", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_subscription_dispatch_rate(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<models::DispatchRate, Error<PersistentTopicsGetSubscriptionDispatchRateError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscriptionDispatchRate", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_subscription_level_dispatch_rate(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, applied: Option<bool>, is_global: Option<bool>, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsGetSubscriptionLevelDispatchRateError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/{subName}/dispatchRate", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_subscription_properties(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsGetSubscriptionPropertiesError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}/properties", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_subscription_types_enabled(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, is_global: Option<bool>, authoritative: Option<bool>) -> Result<Vec<String>, Error<PersistentTopicsGetSubscriptionTypesEnabledError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscriptionTypesEnabled", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_get_subscriptions(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<Vec<String>, Error<PersistentTopicsGetSubscriptionsError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscriptions", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_grant_permissions_on_topic(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, role: &str, body: Option<Vec<String>>) -> Result<(), Error<PersistentTopicsGrantPermissionsOnTopicError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/permissions/{role}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), role=crate::apis::urlencode(role));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_offload_status(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsOffloadStatusError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/offload", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_peek_nth_message(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, message_position: i32, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsPeekNthMessageError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}/position/{messagePosition}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name), messagePosition=message_position);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn persistent_topics_remove_backlog_quota(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, backlog_quota_type: Option<&str>, authoritative: Option<bool>, is_global: Option<bool>) -> Result<(), Error<PersistentTopicsRemoveBacklogQuotaError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/backlogQuota", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn persistent_topics_reset_cursor(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, timestamp: i64, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsResetCursorError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}/resetcursor/{timestamp}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name), timestamp=timestamp);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_reset_cursor_on_position(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, authoritative: Option<bool>, message_id: Option<models::ResetCursorData>) -> Result<(), Error<PersistentTopicsResetCursorOnPositionError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}/resetcursor", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_skip_all_messages(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsSkipAllMessagesError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}/skip_all", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_skip_messages(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, sub_name: &str, num_messages: i32, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsSkipMessagesError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/subscription/{subName}/skip/{numMessages}", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic), subName=crate::apis::urlencode(sub_name), numMessages=num_messages);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_terminate(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsTerminateError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/terminate", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_terminate_partitioned_topic(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsTerminatePartitionedTopicError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/terminate/partitions", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn persistent_topics_trim_topic(configuration: &configuration::Configuration, tenant: &str, namespace: &str, topic: &str, authoritative: Option<bool>) -> Result<(), Error<PersistentTopicsTrimTopicError>> {
    ...
    let local_var_uri_str = format!("{}/non-persistent/{tenant}/{namespace}/{topic}/trim", local_var_configuration.base_path, tenant=crate::apis::urlencode(tenant), namespace=crate::apis::urlencode(namespace), topic=crate::apis::urlencode(topic));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
