...
pub struct OffloadPoliciesImpl {
    #[serde(rename = "fileSystemDriver", skip_serializing_if = "Option::is_none")]
    pub file_system_driver: Option<bool>,
    ...
    #[serde(rename = "gcsDriver", skip_serializing_if = "Option::is_none")]
    pub gcs_driver: Option<bool>,
    ...
    #[serde(rename = "managedLedgerExtraConfigurations", skip_serializing_if = "Option::is_none")]
    pub managed_ledger_extra_configurations: Option<std::collections::HashMap<String, String>>,
    ...
    #[serde(rename = "s3Driver", skip_serializing_if = "Option::is_none")]
    pub s3_driver: Option<bool>,
...
impl OffloadPoliciesImpl {
    pub fn new() -> OffloadPoliciesImpl {
        OffloadPoliciesImpl {
            ...
            managed_ledger_extra_configurations: None,
