...
pub struct NonPersistentPartitionedTopicStatsImpl {
    ...
    pub partitions: Option<std::collections::HashMap<String, models::NonPersistentTopicStatsImpl>>,
...
impl NonPersistentPartitionedTopicStatsImpl {
    pub fn new() -> NonPersistentPartitionedTopicStatsImpl {
