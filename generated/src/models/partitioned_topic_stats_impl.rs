...
pub struct PartitionedTopicStatsImpl {
    ...
    pub partitions: Option<std::collections::HashMap<String, models::TopicStats>>,
...
impl PartitionedTopicStatsImpl {
    pub fn new() -> PartitionedTopicStatsImpl {
